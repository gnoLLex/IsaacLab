...
"""
./isaaclab.sh -p source/standalone/test/franka_env.py --num_envs 32
"""
...
parser = argparse.ArgumentParser(description="Franka Test Env")
...
# Scene definition
##
please use a InteractiveSceneCfg, ActionCfg, ObservationCfg and ManagerBasedCfg
